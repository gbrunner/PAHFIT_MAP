...
readcol, 'll1.tbl', ll1wave, ll1flux, ll1unc
readcol, 'll2.tbl', ll2wave, ll2flux, ll2unc
set_plot, 'ps'
device, filename = 'LL_spec.ps', /LANDSCAPE
plot, ll1wave,ll1flux, xstyle=1,ystyle=1, xrange=[14,39], yrange=[5, 60], xtitle = 'Wavelength (!7l!3m)', ytitle = 'MJy/sr', title = 'M51 Spectrum across the Long-Low Strip', thick = 3, charthick = 3, axis = 3
oplot, ll2wave, ll2flux, thick = 3
