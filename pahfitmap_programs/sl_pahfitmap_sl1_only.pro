...
readcol, 'fake_sl2_1.tbl', fake_wave, fake_sl2_cube, fake_sl2_unc
sl1_cube = mrdfits('ngc5194_strip_SL1_cube.fits',0, sl1_header)
sl1_unc = mrdfits('ngc5194_strip_SL1_cube_unc.fits',0, sl1_unc_header)
sl1_cube = sl1_cube[1:31,1:175,*]
sl1_unc = sl1_unc[1:31,1:175,*]

sl2_x = n_elements(sl1_cube[*,0,0]) 
sl2_y = n_elements(sl1_cube[0,*,0])
sl2_z = n_elements(fake_wave)
sl2_cube = fltarr(sl2_x, sl2_y, 73)
sl2_unc = fltarr(sl2_x, sl2_y, 73)
...
;for i=6,11,1 do begin
;for j=51,56,1 do begin
...
;sl_crval1 = sxpar(sl1_header, 'CRVAL1') ;RA
;sl_crval2 = sxpar(sl1_header, 'CRVAL2') ;Dec
